...
def remove_field(cr, model, fieldname, cascade=False, drop_column=True, skip_inherit=(), keep_as_attachments=False):
    ...
    # remove o2m fields that will be removed due to the removal of the entry in ir_model_fields
    # since relation_field_id has a FK constraint with ON DELETE CASCADE
