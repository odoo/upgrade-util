...
class _Replacer(ast.NodeTransformer):
    ...
    def __init__(self, mapping):
        ...
        self.matched = False  # whether some match was found
    ...
    def _match_List(self, left, right):
        return self._all_match(left.elts, right.elts)
...
def literal_replace(expr, mapping):
    ...
    visited = replacer.visit(root)
    return ast_unparse(visited).strip() if replacer.matched else expr
